...
import { AlertCircle, CheckCircle2, X, Shield, Mail, Lock, Eye, EyeOff, Loader2, User, Sparkles } from "lucide-react";
...
export function LoginPage() {
  ...
  return (
    <main className="min-h-screen w-full flex flex-col lg:flex-row bg-[#F7F9F7] font-sans overflow-hidden relative">
      ...
      {/* Floating Theme Toggle Hidden for Now
        ...
        >
          ...
          <div className="mb-8 text-center lg:text-left mt-8 lg:mt-0">
            ...
            <p className="text-base text-slate-500 font-medium">
              {mode === 'login' 
                ? "Access your AuraFlow wellness dashboard." 
                : mode === 'register'
