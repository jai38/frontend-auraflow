...
import { 
  ...
  PenTool, MessageSquare, Clock, Users, HelpCircle, Sparkles 
} from "lucide-react";
...
export function LandingPage() {
  ...
  useEffect(() => {
    document.title = "AuraFlow — Get to know yourself, feel a little better";
  }, []);
  ...
  const handleWriteFlowClick = () => {
    if (!config.enableWriteFlow) {
    ...
    <div className="min-h-screen bg-paper text-ink font-sans selection:bg-rose/20 selection:text-ink relative overflow-x-hidden pb-12 flex flex-col justify-between">
      ...
      <div>
        ...
        <main className="mx-auto max-w-6xl px-6 relative z-10">
          ...
          {/* Two Ways In: WriteFlow & TalkFlow */}
              ...
              <div className="bg-card border border-line rounded-[2rem] p-8 shadow-sm flex flex-col justify-between hover:shadow-md transition-all">
                <div>
                  <div className="flex items-center gap-3.5 mb-6">
                    ...
                    <div>
                      <h3 className="font-serif text-2xl font-bold text-ink">WriteFlow</h3>
              ...
              <div className="bg-card border border-line rounded-[2rem] p-8 shadow-sm flex flex-col justify-between hover:shadow-md transition-all">
                <div>
                  <div className="flex items-center gap-3.5 mb-6">
                    ...
                    <div>
                      <h3 className="font-serif text-2xl font-bold text-ink">TalkFlow</h3>
          ...
          <section className="py-16 border-t border-line/60" id="safety-trust">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-sm text-ink-soft mb-12">
                Opening up to strangers is scary. So we built TalkFlow to make it safe before it makes it social.
              </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
              <div className="lg:col-span-5 flex flex-col justify-center">
                ...
                <p className="text-sm text-ink-soft leading-relaxed">
                  AuraFlow shares nothing about you as an individual — not your check-ins, not your messages, not your identity. Universities only ever see the bigger picture: when whole groups are stressed, when exam season bites. The pulse of the campus, never the student.
                </p>
              </div>
                ...
                <div className="bg-card border border-line rounded-[2rem] overflow-hidden shadow-sm">
                  ...
                  <div className="divide-y divide-line/60">
                    <div className="p-5 grid grid-cols-12 gap-4 text-xs">
                      ...
                      <div className="col-span-4 font-semibold text-teal">AuraFlow</div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-6 bg-slate-950/60 backdrop-blur-sm select-none">
            ...
            >
              ...
              <ul className="space-y-3 mb-8 text-xs sm:text-sm font-semibold text-slate-700">
                ...
                <li className="flex gap-2.5 items-start">
                  <span className="text-plum mt-0.5">✔</span>
                  <span><b>Two bigger features are still coming</b> — you'll see WriteFlow and TalkFlow here as previews, not finished yet.</span>
                </li>
                <li className="flex gap-2.5 items-start">
                  <span className="text-plum mt-0.5">✔</span>
