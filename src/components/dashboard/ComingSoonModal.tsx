...
const FEATURE_DETAILS = {
  writemindly: {
    ...
    description: "Type whatever's on your mind — messy, half-formed, 2am, all of it. WriteFlow helps you slow down long enough to hear your own thoughts. Sometimes that's all you need. No advice unless you want it.",
    icon: PenTool,
