      ...
      return (
        <div className="space-y-5">
          ...
          <ShareCard accent={accent} cardRef={cardRef}>
            ...
            <p className="mt-5 text-[10px] opacity-75 tracking-wider uppercase font-bold">AuraFlow · Discover</p>
          </ShareCard>
        </div>
      );
    }
        ...
        <div className="space-y-5">
          ...
          {cur.card && (
            <ShareCard accent={accent} cardRef={cardRef}>
              ...
              <p className="text-[10px] opacity-75 tracking-wider uppercase font-bold">{typeInfo?.tag || cur.title} · AuraFlow</p>
            </ShareCard>
          )}
      ...
      return (
        <div className="space-y-5">
          ...
          <ShareCard accent={accent} cardRef={cardRef}>
            ...
            <p className="text-[10px] opacity-75 tracking-wider uppercase font-bold">AuraFlow · Discover</p>
          </ShareCard>
  ...
  return (
    <div ref={reportRef} id="printable-report-card" className="space-y-6 select-none bg-white/70 border border-white/20 rounded-[32px] p-8 shadow-xl backdrop-blur-md relative overflow-hidden transition-all duration-300">
      ...
      <div className="hidden print:block border-b border-slate-200 pb-4 mb-6">
        <h1 className="text-2xl font-black font-serif text-slate-900">AuraFlow</h1>
